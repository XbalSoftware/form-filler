...
enum DebugSeeder {
    ...
    private static let boxes: [Box] = [
        ...
        Box(label: "Date of birth", fieldName: "Patient Date of Birth", type: .patientDateOfBirth,
            pageIndex: 0, frame: CGRect(x: 170, y: 170, width: 160, height: 24)),
        Box(label: "Referral date", fieldName: "Referral Date", type: .singleLineText,
            pageIndex: 0, frame: CGRect(x: 170, y: 210, width: 160, height: 24)),
        Box(label: "Urgent", fieldName: "Urgent", type: .singleLineText,
            pageIndex: 0, frame: CGRect(x: 170, y: 252, width: 160, height: 24)),
