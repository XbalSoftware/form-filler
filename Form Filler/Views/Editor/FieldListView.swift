...
struct FieldListView: View {
    ...
    private func icon(for type: FieldType) -> String {
        ...
        case .patientAddress: "house"
        case .patientDateOfBirth: "birthday.cake"
        case .patientHealthcareNumber: "cross.case"
        case .patientPhone: "phone.bubble"
        case .patientRefractionOD, .patientRefractionOS: "eyeglasses"
        case .patientVisualAcuityOD, .patientVisualAcuityOS: "eye"
        case .patientKeratometryOD, .patientKeratometryOS: "circle.dashed"
        case .patientIntraocularPressureOD, .patientIntraocularPressureOS: "gauge.medium"
        case .referralDate: "calendar"
        }
    }
}
